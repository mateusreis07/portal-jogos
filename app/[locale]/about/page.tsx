...
export const metadata: Metadata = {
  title: 'About Us - Arcade Hub',
  description: 'Learn more about Arcade Hub, the premier destination for free online HTML5 browser games.',
};
    ...
    <div className="max-w-4xl mx-auto py-12 px-4 sm:px-6 lg:px-8">
      <div className="bg-slate-800/50 border border-slate-700 rounded-2xl p-8 md:p-12 shadow-xl">
        <h1 className="text-4xl font-extrabold text-white tracking-tight mb-8 text-center flex items-center justify-center gap-3">
          <span className="text-primary text-3xl">🎮</span> About Arcade Hub
        </h1>

        <div className="prose prose-invert prose-lg max-w-none">
          <p className="text-slate-300 leading-relaxed mb-6">
            Welcome to <strong>Arcade Hub</strong>, your ultimate destination for free online browser games. We believe that gaming should be accessible, instantaneous, and fun for everyone, anywhere, at any time.
          </p>

          <h2 className="text-2xl font-bold text-white mt-10 mb-4">Our Mission</h2>
          <p className="text-slate-300 leading-relaxed mb-6">
            Our mission is to curate and provide the highest quality HTML5 games on the web. Whether you're on a desktop computer during a break, or on your mobile phone commuting, Arcade Hub delivers blazing fast games without the need for downloads or installations.
          </p>
          ...
          <div className="bg-slate-900/50 p-6 rounded-xl border border-slate-700/50 mt-10">
            ...
            <p className="text-slate-400 text-base m-0">
              Are you an HTML5 game developer? We are always looking for great content to share with our audience. Contact us to feature your games on Arcade Hub!
            </p>
          </div>
        </div>
      </div>
